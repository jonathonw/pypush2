...
def main():
  ...
  dial1 = pypush2.ui.Dial("Dial 1", 3.4, 0, 10)
  tab1.add_dial(dial1)

  dial2 = pypush2.ui.Dial("Dial 2", 10.0, 0, 10)
  tab1.add_dial(dial2)

  dial3 = pypush2.ui.Dial("Dial 3", 0.0, 0, 10)
  tab1.add_dial(dial3)

  dial4 = pypush2.ui.Dial("Dial 4", 0.001, 0, 10, colors.PUSH_COLORS_DICT["red"], colors.PUSH_COLORS_DICT["cedar_wood_finish"], colors.PUSH_COLORS_DICT["white"])
  tab1.add_dial(dial4)

  dial5 = pypush2.ui.Dial("Dial 5", 9.999, 0, 10)
  tab1.add_dial(dial5)
  ...
  dial33 = pypush2.ui.Dial("This dial has a long name", 6.6, 0, 10)
  tab3.add_dial(dial33)

  dial34 = pypush2.ui.Dial("This dial is a different color", 5.0, 0, 10, colors.PUSH_COLORS_DICT["red"], colors.PUSH_COLORS_DICT["cedar_wood_finish"], colors.PUSH_COLORS_DICT["white"])
  tab3.add_dial(dial34)

  dial35 = pypush2.ui.Dial("Moo", 2.2, 0, 10)
